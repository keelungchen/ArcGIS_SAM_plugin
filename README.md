...
every 250 ms instead of once a second. Also ships the **RITM-only
edition** (`INSTALL_RITM_ONLY.bat`), which skips the SAM python
packages and the SAM geoprocessing toolbox.
